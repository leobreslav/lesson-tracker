...
/**
 * Скобка недели: у каждой строки — номер недели и её место в группе.
 *
 * Неделя удобнее как единица планирования, чем отдельная дата, но строкой
 * она стоила бы по строке на каждые три урока. Поэтому — вертикальная
 * скобка слева: подпись на средней строке группы, линия во всю её высоту,
 * вертикального места ноль.
 *
