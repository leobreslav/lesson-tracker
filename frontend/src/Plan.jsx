  ...
  return (
    <main className="page wide">
      <header className="page-header">
        ...
        */}
        {/* пока курс не выбран, утверждать нечего: отправлять на подпись и
            сравнивать с эталоном не с чем, а кнопка, умеющая только
            отказать, честнее не нарисованная */}
        {!supervising && !onShelf && classId && (
