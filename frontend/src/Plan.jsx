    ...
    <main className="page wide">
      <header className="page-header">
        ...
        */}
        <CoursePicker
          courses={pickable}
          value={onShelf ? `t${template}` : classId}
          onChange={pickObject}
          label={classLabel}
          groups={groups}
          ...
          narrow="plan"
        />
        {onShelf && shelfCard && !shelfCard.is_published && (
          <span className="hint">{t('plan.shelf.draft')}</span>
        )}
        {/*
      ...
      {/*
        ...
        Не показывается она ровно там, где неверна: у чужого плана правок
        нет никаких, и обещать их нельзя.
      */}
      {!supervising && !comparing && (
        <p className="hint plan-context">
          {t(onShelf ? 'plan.context.template' : 'plan.context.course')}
        </p>
      )}
