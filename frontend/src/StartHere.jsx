...
/**
 * Шаги первого входа — на корне приложения.
 *
 * Жили они на «Моих курсах», и вместе с тем разделом уезжать им было некуда:
 * это карта для того, у кого ещё ничего не заведено, и показывать её надо
 * там, куда он попадает. Корень — расписание, значит здесь.
 *
 * Показываются, **пока есть что настраивать**: пройденные повторяли бы то,
 * что и так видно на самой странице.
 */
