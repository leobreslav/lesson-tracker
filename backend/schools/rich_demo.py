...
намеренно — на нём смотрят вёрстку, и его даты от прогона к прогону одни и
те же.
...
нужны **фиксированные** даты, иначе посев не воспроизводится;
...
def paper_work(course, teacher, group, now, *, salt) -> int:
    ...
    for index, student in enumerate(group):
        ...
        # сотни, а у чистого клона ключей R2 нет вовсе — экран же
