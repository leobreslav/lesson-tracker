...
class Work(models.Model):
    ...
    Работа **личная**, как расписание и план: пара «учитель и курс». Курс
    общий, и двое ведущих одну параллель дают разные контрольные — общая
    работа означала бы, что правку одного видит группа другого.

    Обратная сторона одна, и она записана честно: ученик зачислен на
    **курс**, а не к учителю, поэтому в курсе, который ведут двое, он увидит
    работы обоих. Разделить это можно было бы только группами, а групп в
    модели нет — школа сама решила считать эти две группы одним курсом.
    """
    ...
    lesson = models.ForeignKey(
        ...
        null=True,
        blank=True,
        # урок плана могут удалить, и работа это переживает: она про то,
        # что уже решали, а не про строку плана
        on_delete=models.SET_NULL,
        verbose_name="lesson of the plan",
    )
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=("teacher", "course"), name="work_owner_idx"),
        ]
