...
def configured() -> bool:
    ...
    Не настроено — это обычное состояние чистого клона и облачной сессии:
    ключей R2 там нет, и писать в чужой бакет им незачем. Отвечать
    ...
    Поймано на контуре без ключей: backend падал ещё до gunicorn'а. У класса
